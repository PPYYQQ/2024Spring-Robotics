...
def sim_l():
    ...
    from utils_light import is_add_car, Car, TrafficLight, return_para
    ...
    """)
        ...
        delay_curve.append((frame, delay/frame))
        flow_curve.append((frame, count/frame))
        # 绘制红绿灯和车辆
        ...
        # pygame.image.save(screen, f'./light_frames/frame_{frame:03d}.png')

        pygame.display.flip()
        pygame.time.Clock().tick(FPS)

    pygame.quit()
    return delay_curve, flow_curve
